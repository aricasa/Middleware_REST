...
public class OauthPostTest
{
    ...
    @Test
    public void correctPostOuath() throws IOException, InterruptedException
    {
    ...
    @Test
    public void incorrectPostOuath() throws IOException, InterruptedException
    {
        HttpGet httpGet = new HttpGet("http://localhost:4567/users/pinco/oauth2/clients");
